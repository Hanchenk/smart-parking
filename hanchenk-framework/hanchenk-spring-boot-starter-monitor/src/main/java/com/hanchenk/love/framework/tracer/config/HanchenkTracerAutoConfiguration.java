...
import com.hanchenk.love.framework.tracer.core.aop.BizTraceAspect;
import com.hanchenk.love.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "hanchenk.tracer", value = "enable", matchIfMissing = true)
public class HanchenkTracerAutoConfiguration {
