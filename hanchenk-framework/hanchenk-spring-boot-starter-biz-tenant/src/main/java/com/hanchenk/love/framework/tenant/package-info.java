 ...
 *      1）Spring Async：
 *          {@link com.hanchenk.love.framework.quartz.config.HanchenkAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 HanchenkSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.hanchenk.love.framework.tenant;
