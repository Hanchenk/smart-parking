package com.hanchenk.love.module.system.controller.admin.socail.vo.client;
...
import com.hanchenk.love.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "hanchenk商城")
