package com.hanchenk.love.module.infra.service.codegen.inner;
...
import com.hanchenk.love.framework.apilog.core.enums.OperateTypeEnum;
...
import com.hanchenk.love.framework.common.util.date.LocalDateTimeUtils;
import com.hanchenk.love.framework.common.util.object.BeanUtils;
import com.hanchenk.love.framework.common.util.object.ObjectUtils;
import com.hanchenk.love.framework.common.util.string.StrUtils;
import com.hanchenk.love.framework.excel.core.annotations.DictFormat;
import com.hanchenk.love.framework.excel.core.convert.DictConvert;
import com.hanchenk.love.framework.excel.core.util.ExcelUtils;
import com.hanchenk.love.framework.mybatis.core.dataobject.BaseDO;
...
import com.hanchenk.love.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "hanchenk-module-${table.moduleName}/" + // 顶级模块
                "hanchenk-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "hanchenk-module-${table.moduleName}/" + // 顶级模块
                "hanchenk-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "hanchenk-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "hanchenk-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
