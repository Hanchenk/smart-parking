...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hanchenk";
    private static final String ARTIFACT_ID = "hanchenk";
    private static final String PACKAGE_NAME = "com.hanchenk.love";
    private static final String TITLE = "智能停车收费管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hanchenk";
        String artifactIdNew = "hanchenk";
        String packageNameNew = "com.hanchenk.love";
        String titleNew = "智能停车收费管理系统";
        String projectBaseDirNew = "D:\\empowering\\smart-parking"; // 更改为你想要的新目录
